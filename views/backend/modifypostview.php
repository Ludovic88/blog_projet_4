...
<form action="<?= PATH_PREFIX ?>/admin/updatepost?id=<?= $post['id'] ?>" method="post" class="form-group">
...
<form action="/courPHP/blog_projet_4/admin/deletepost?id=<?= $post['id'] ?>" method="post" class="form-group">
...
?>
    ...
    <p><a href="<?= PATH_PREFIX ?>/admin/deletecomment?id=<?= $comment['id'] ?>" style="color: red;">Supprimer le commentaire</a></p>
<?php
} 
?>